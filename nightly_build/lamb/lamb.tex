...
The Lamb problem is a notably difficult problem to solve numerically, due to the singular surface source
and broadband wave excitation.
Finite element discretization, domain truncation, and the use of Rayleigh damping introduce numerical
dispersion and artificial attenuation, which affects surface wave propagation.
