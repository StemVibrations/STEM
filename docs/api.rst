...
.. note::
   Heavy optional dependencies (Kratos, gmsh-utils) are mocked during the docs build
   to keep the API pages renderable on machines without those packages installed.
