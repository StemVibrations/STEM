...
$\times$ \qty{10}{\meter} soil layer, modeled with second order tetrahedral elements. The mesh uses an average
...
The mesh is locally refined beneath the loaded area, with an average element size of approximately \qty{0.015}{\meter}.
...
\begin{figure}
    ...
    \caption{Geometry and mesh adopted for the 3D boussinesq benchmark with a circular distributed load.}
