...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
    \item \textbf{Unit Tests}: Verify the correctness of individual functions and classes (e.g., mesh generation,
        load application). A total of 255 unit tests are implemented, covering the various components of STEM.
    \item \textbf{Benchmarks}: Validate the integrated system against known physical phenomena, analytical solutions,
        or established engineering scenarios. A total of 67 benchmark tests are implemented,
        covering a wide range of scenarios relevant to railway-induced vibrations.
