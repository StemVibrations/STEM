...
def test_interface_3d():
    ...
    names = [
        "interface_high_stiffness_roller",
        "interface_low_stiffness_roller",
        "interface_high_stiffness_no_roller",
    ...
    stiffness_interface_list = [1e20, 1e3, 1e20, 1e1]
    ndim = 3
    results = {}
    for name, roller, interface_stiffness in zip(names, roller_settings, stiffness_interface_list):
        model = Model(ndim)
        ...
        surface_load = SurfaceLoad(active=[False, False, True], value=[0, 0, -100])
        ...
        input_folder = "benchmark_tests/test_interfaces_3d/" + name
