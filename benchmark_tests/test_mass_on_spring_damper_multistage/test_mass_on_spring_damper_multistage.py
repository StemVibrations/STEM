...
def test_stem():
    ...
    # create new stage
    model_stage_2 = stem.create_new_stage(delta_time, 1)
    ...
    model_stage_2.body_model_parts[0].material.material_parameters.NODAL_DISPLACEMENT_STIFFNESS = [0,5000,0]
    # model_stage_2.body_model_parts[0].material.constitutive_law.POISSON_RATIO = 0.1

    # model_stage_2.process_model_parts[0].parameters.value = [0, -1000, 0]
    model_stage_2.output_settings[0].output_name = "output_mass2"
    ...
    with open(os.path.join(input_folder, "./output_mass2.json")) as f:
        calculated_data2 = json.load(f)
    #
    ...
    if SHOW_RESULTS:
        ...
        plt.plot(calculated_data2["TIME"], calculated_data2["NODE_2"]["DISPLACEMENT_Y"])
        plt.show()
