...
def test_stem():
    ...
    bridge_soil_formulation = OnePhaseSoil(ndim, IS_DRAINED=True, DENSITY_SOLID=bridge_density,
    ...
    material_bridge = SoilMaterial(
        "steel",
        bridge_soil_formulation,
        bridge_constitutive_law,
    ...
    moving_load = MovingLoad(load=[0.0, -10.0, 0.0], direction=[1, 1, 1], velocity=2.5, origin=[0.5, 1.0, 0.0], offset=0.0)
    ...
    model.add_boundary_condition_by_geometry_ids(2, [11, 14, 16, 17, 22, 24], roller_displacement_parameters, "sides_roller")
