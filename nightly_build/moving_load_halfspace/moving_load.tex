...
which is not present in the analytical solution, and which related to the domain truncation, and boundary conditions
...
\begin{figure}[h]
	...
	\caption{Comparison of the vertical displacement time history at a point located in the middle of the model at
	 ...
	 the halfspace, at a depth of \qty{-1}{\meter}.}
