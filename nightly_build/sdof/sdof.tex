...
\begin{figure}
    \centering
    \includegraphics[width=0.25\textwidth]{sdof/sdof.pdf}
...
acceleration parameters $\beta = 0.25$ and $\gamma = 0.5$.
...
\begin{figure}[h]
	...
	\caption{Comparison between the STEM and analytical solution for the displacement of the single degree of freedom.}
