...
In both cases, an average element size of \qty{0.05}{\meter} is adopted.
...
\begin{figure}
	...
	\caption{Geometry and mesh adopted for the one-dimensional wave propagation with absorbing boundary benchmark.}
...
The dynamic analysis is performed over a \qty{0.15}{\second} time window, with a time step of \qty{0.0005}{\second}.
