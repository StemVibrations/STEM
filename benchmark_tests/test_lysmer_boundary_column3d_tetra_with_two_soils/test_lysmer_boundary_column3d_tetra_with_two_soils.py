...
def test_stem():
    ...
    model.add_soil_layer_by_coordinates(layer1_coordinates, material1, "layer1", "Section 1")
    model.add_soil_layer_by_coordinates(layer2_coordinates, material2, "layer2", "Section 1")
