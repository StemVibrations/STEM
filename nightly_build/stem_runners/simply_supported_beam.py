...
def run_simply_supported_beam(input_folder: Path, ndim: int, axis_index: int = 0):
    ...
    Args:
        - input_folder (Path): Folder to store the input and output files.
        - ndim (int): Dimension of the problem (2 or 3).
        - axis_index (int): Index of the axis which the beam follows (0 for x, 1 for y, 2 for z).
    """
