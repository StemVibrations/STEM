...
Overview
--------
This tutorial shows how to set up a 3D geometry where the soil layers vary in the Z direction.
Furthermore, a track is defined which lays on top of the soil and extends outside of the soil domain. The
...
are spaced 0.5 m from each others which results in a 50 m straight track, with part name "rail_track".
