...
foundation_coordinates_top = [(0.0, surface_level, 0.0), (7.5, surface_level, 0.0),
                              (7.5, surface_level-thickness_foundation_top, 0.0),
...
foundation_coordinates_bottom = [(0.0, surface_level-thickness_foundation_top, 0.0),
                                 (7.5, surface_level-thickness_foundation_top, 0.0),
                                 (7.5, surface_level-thickness_foundation_top-thickness_foundation_bottom, 0.0),
...
deep_wall_part_1_coordinates = [(x_coord_deep_wall, surface_level, 0.0), (x_coord_deep_wall+thickness_deep_wall, surface_level, 0.0),
                                (x_coord_deep_wall+thickness_deep_wall, layer_1_boundary_depth, 0.0), (x_coord_deep_wall, layer_1_boundary_depth, 0.0)]
deep_wall_part_2_coordinates = [(x_coord_deep_wall, layer_1_boundary_depth, 0.0), (x_coord_deep_wall+thickness_deep_wall, layer_1_boundary_depth, 0.0),
                                (x_coord_deep_wall+thickness_deep_wall, layer_2_boundary_depth, 0.0), (x_coord_deep_wall, layer_2_boundary_depth, 0.0)]
deep_wall_part_3_coordinates = [(x_coord_deep_wall, layer_2_boundary_depth, 0.0), (x_coord_deep_wall+thickness_deep_wall, layer_2_boundary_depth, 0.0),
                                (x_coord_deep_wall+thickness_deep_wall, layer_2_boundary_depth-length_in_sand, 0.0), (x_coord_deep_wall, layer_2_boundary_depth-length_in_sand, 0.0)]

# coordinates for the ditch with a 1:1 slope
depth_ditch = 1.5
width_bottom_ditch = 2
x_coordinate_end_ditch = x_coord_deep_wall+thickness_deep_wall + depth_ditch*2 + width_bottom_ditch
ditch_coordinates = [(x_coord_deep_wall+thickness_deep_wall, surface_level, 0.0), (x_coord_deep_wall+thickness_deep_wall + depth_ditch, surface_level - depth_ditch, 0.0),(x_coord_deep_wall+thickness_deep_wall + depth_ditch + width_bottom_ditch, surface_level - depth_ditch, 0.0),
                    (x_coordinate_end_ditch, surface_level, 0.0)]


soil_1_coordinates_part_1 = [(0.0, surface_level-thickness_foundation_bottom-thickness_foundation_top, 0.0),
                             (7.5, surface_level-thickness_foundation_bottom-thickness_foundation_top, 0.0),
                             (7.5, surface_level-thickness_foundation_top, 0.0),
                             (7.5, surface_level, 0.0), (x_coord_deep_wall, surface_level, 0.0), (x_coord_deep_wall,layer_1_boundary_depth,0.0), (0.0, layer_1_boundary_depth, 0.0)]
soil_1_coordinates_part_2 = ditch_coordinates + [(max_x_coordinate, surface_level, 0.0), (max_x_coordinate,layer_1_boundary_depth,0.0), (x_coord_deep_wall+thickness_deep_wall, layer_1_boundary_depth, 0.0)]

soil_2_coordinates_part_1 = [(0.0, layer_1_boundary_depth, 0.0), (x_coord_deep_wall, layer_1_boundary_depth, 0.0), (x_coord_deep_wall, layer_2_boundary_depth, 0.0), (0.0, layer_2_boundary_depth, 0.0)]
soil_2_coordinates_part_2 = [(x_coord_deep_wall+thickness_deep_wall, layer_1_boundary_depth, 0.0), (max_x_coordinate, layer_1_boundary_depth, 0.0), (max_x_coordinate, layer_2_boundary_depth, 0.0), (x_coord_deep_wall+thickness_deep_wall, layer_2_boundary_depth, 0.0)]


soil_3_coordinates = [(0.0, layer_2_boundary_depth, 0.0), (x_coord_deep_wall, layer_2_boundary_depth, 0.0), (x_coord_deep_wall, layer_2_boundary_depth-length_in_sand, 0.0), (x_coord_deep_wall+thickness_deep_wall, layer_2_boundary_depth-length_in_sand, 0.0),
                        (x_coord_deep_wall+thickness_deep_wall, layer_2_boundary_depth, 0.0), (max_x_coordinate, layer_2_boundary_depth, 0.0), (max_x_coordinate, bottom_coordinate, 0.0), (0.0, bottom_coordinate, 0.0)]
...
model.add_soil_layer_by_coordinates(soil_2_coordinates_part_1, material_peat, "soil_layer_2_part_1")
model.add_soil_layer_by_coordinates(soil_2_coordinates_part_2, material_peat, "soil_layer_2_part_2")
...
model.add_soil_layer_by_coordinates(deep_wall_part_1_coordinates, material_clay, "deep_wall_part_1")
model.add_soil_layer_by_coordinates(deep_wall_part_2_coordinates, material_peat, "deep_wall_part_2")
model.add_soil_layer_by_coordinates(deep_wall_part_3_coordinates, material_sand, "deep_wall_part_3")
