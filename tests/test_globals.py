...
class TestGlobalsStem:
    ...
    def test_point(self):
        ...
        assert ELEMENT_DATA["POINT_1N"]["element_order"] == 1
        assert ELEMENT_DATA["POINT_1N"]["n_vertices"] == 1
        assert ELEMENT_DATA["POINT_1N"]["reversed_connectivity_order"] == [0]
    ...
    def test_line2n(self):
        ...
        assert ELEMENT_DATA["LINE_2N"]["element_order"] == 1
        assert ELEMENT_DATA["LINE_2N"]["n_vertices"] == 2
        assert ELEMENT_DATA["LINE_2N"]["reversed_connectivity_order"] == [1, 0]
    ...
    def test_line3n(self):
        ...
        assert ELEMENT_DATA["LINE_3N"]["element_order"] == 2
        assert ELEMENT_DATA["LINE_3N"]["n_vertices"] == 2
        assert ELEMENT_DATA["LINE_3N"]["reversed_connectivity_order"] == [1, 0, 2]
    ...
    def test_tri3n(self):
        ...
        assert ELEMENT_DATA["TRIANGLE_3N"]["element_order"] == 1
        assert ELEMENT_DATA["TRIANGLE_3N"]["n_vertices"] == 3
        assert ELEMENT_DATA["TRIANGLE_3N"]["reversed_connectivity_order"] == [2, 1, 0]
    ...
    def test_tri6n(self):
        ...
        assert ELEMENT_DATA["TRIANGLE_6N"]["element_order"] == 2
        assert ELEMENT_DATA["TRIANGLE_6N"]["n_vertices"] == 3
        assert ELEMENT_DATA["TRIANGLE_6N"]["reversed_connectivity_order"] == [2, 1, 0, 4, 3, 5]
    ...
    def test_quad4n(self):
        ...
        assert ELEMENT_DATA["QUADRANGLE_4N"]["element_order"] == 1
        assert ELEMENT_DATA["QUADRANGLE_4N"]["n_vertices"] == 4
        assert ELEMENT_DATA["QUADRANGLE_4N"]["reversed_connectivity_order"] == [1, 0, 3, 2]
    ...
    def test_quad8n(self):
        ...
        assert ELEMENT_DATA["QUADRANGLE_8N"]["element_order"] == 2
        assert ELEMENT_DATA["QUADRANGLE_8N"]["n_vertices"] == 4
        assert ELEMENT_DATA["QUADRANGLE_8N"]["reversed_connectivity_order"] == [1, 0, 3, 2, 4, 7, 6, 5]
    ...
    def test_tetra4n(self):
        ...
        assert ELEMENT_DATA["TETRAHEDRON_4N"]["element_order"] == 1
        assert ELEMENT_DATA["TETRAHEDRON_4N"]["n_vertices"] == 4
        assert ELEMENT_DATA["TETRAHEDRON_4N"]["reversed_connectivity_order"] == [1, 0, 2, 3]
    ...
    def test_tetra10n(self):
        ...
        assert ELEMENT_DATA["TETRAHEDRON_10N"]["element_order"] == 2
        assert ELEMENT_DATA["TETRAHEDRON_10N"]["n_vertices"] == 4
        assert ELEMENT_DATA["TETRAHEDRON_10N"]["reversed_connectivity_order"] == [1, 0, 2, 3, 4, 6, 5, 8, 7, 9]
    ...
    def test_hexa8n(self):
        ...
        assert ELEMENT_DATA["HEXAHEDRON_8N"]["element_order"] == 1
        assert ELEMENT_DATA["HEXAHEDRON_8N"]["n_vertices"] == 8
        assert ELEMENT_DATA["HEXAHEDRON_8N"]["reversed_connectivity_order"] == [1, 0, 3, 2, 5, 4, 7, 6]
