...
class TestStem:
    ...
    def test_finalise_stage_json_output(self):
        """
        Test the finalise method of the Stem class with JsonOutputParameters. It only attempts to post-process the
        json file.
        """
        ...
        # initialize the stem object
        stem = Stem(initial_stage=model, input_files_dir="input_files")
