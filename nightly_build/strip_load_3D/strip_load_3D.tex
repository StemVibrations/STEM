% ==============================================================================================
\chapter{Dynamic strip load on 3D elastic halfspace} \label{ch:strip_load_3D}
% ==============================================================================================
...
This test is the 3D extension of the 2D strip load benchmark presented in Chapter~\ref{ch:strip_load_2D}.
...
% ..............................................................................................
The soil domain is modelled in 3D and  represents a \qty{20}{\meter} (x-direction) by \qty{10}{\meter}
(y-direction) soil layer, extruded to \qty{1}{\meter} thickness in the z-direction, and modelled with high-order
 tetrahedral elements. The mesh uses an average element size of \qty{0.15}{\meter}.
 Figure~\ref{fig:strip3d_mesh} illustrates the geometry and mesh
adopted for the analysis.

The strip load is applied at the surface with a width of \qty{1}{\meter}, and thickness of \qty{1}{\meter}
(across the z-direction).
A downward surface load with magnitude \qty{1e6}{\newton\per\meter\squared} is applied instantaneously and kept
...
The front and back surface ($z=0$ and $z=1$) are prevented from moving in the z-direction, to simulate plane-strain
conditions along the extrusion axis.
...
\section{Results}
% ----------------------------------------------------------------------------------------------
Figure~\ref{fig:strip3d_results} presents the vertical stress at a depth of {\qty{-1}{\meter}}
