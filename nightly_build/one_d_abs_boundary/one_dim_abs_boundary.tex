...
The analytical solution for 1D wave propagation is presented in~\cite{Verruijt_2010}, rhis solution is extended by
adding absorption. When the wave has arrived at the bottom of the column, reflection is prevented by keeping the
velocity constant and the displacement linearly increasing.
...
\begin{figure}
	\centering
	\includegraphics[width=0.30\textwidth]{one_dim_wave_prop/mesh.png}
...
vertical velocity at a point located at:  \qty{5}{\meter} along the height of the column.
