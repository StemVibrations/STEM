...
class TestKratosMaterialIO:
    ...
    def test_write_interface_material_dict(self):
        """
        ...
        YOUNG_MODULUS = 50e6
        POISSON_RATIO = 0.3
        linear_elastic_law = LinearElasticSoil(YOUNG_MODULUS=YOUNG_MODULUS, POISSON_RATIO=POISSON_RATIO)
        # UMAT formulation
        ...
        interface_material_parameters = InterfaceMaterial(name="test_interface_material_one_phase_linear_elastic",
                                                          constitutive_law=linear_elastic_law,
